...
public class JamesHelper {
  ...
  public List<MailMessage> waitForMail(String username, String password, int timeout)
  ...
  public List<MailMessage> getAllMail(String username, String password)
          throws MessagingException {
  ...
  private static MailMessage toModelMail(Message m) {
    try {
      return new MailMessage(m.getAllRecipients()[0].toString(),
              (String) m.getContent());
